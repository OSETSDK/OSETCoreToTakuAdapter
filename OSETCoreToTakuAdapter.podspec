Pod::Spec.new do |s|
  s.name         = "OSETCoreToTakuAdapter"
  s.version      = "6.6.1.1"
  s.summary      = "AdSet广告对接Taku适配器"
  s.description  = <<-DESC
                    OSETSDK 是一个专业的广告聚合SDK，提供高效的广告展示和收益优化功能。
                    DESC
  s.homepage     = "https://github.com/OSETSDK/OSETCoreToTakuAdapter"
  ...
  # 源文件配置
  s.source       = {
    :git => 'https://github.com/OSETSDK/OSETCoreToTakuAdapter.git',
    :tag => s.version.to_s
  }
  # 主框架文件
  # 检查 OSETToBidAdapter.podspec 关键字段
  s.source_files = 'OSETCoreToTakuAdapter/**/*.{h,m}'
  # 系统框架依赖
